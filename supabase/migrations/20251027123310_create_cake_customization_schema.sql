/*
  # Create Cake Customization System Schema

  ## Overview
  Complete database schema for a cake shop with customization capabilities, including products, cart, orders, and customization options.
  ...
  - `products` - Products/oils available for purchase
    - `id` (uuid, primary key)
    - `name` (text)
    - `description` (text)
    - `price_per_litre` (numeric)
    - `offer_price_per_litre` (numeric, nullable)
  ...
  - `flavours` - Available cake flavours
    - `id` (uuid, primary key)
    - `name` (text, unique)
  ...
  - `tiers` - Cake tier configurations
    - `id` (uuid, primary key)
    - `tier_number` (integer, unique)
    - `min_weight_kg` (numeric)
    - `max_weight_kg` (numeric)
    - `tier_cost` (numeric) - Additional charge for complexity

  - `design_models` - Design models per tier
    - `id` (uuid, primary key)
  ...
  - `toppings` - Available cake toppings
    - `id` (uuid, primary key)
    - `name` (text, unique)
    - `price` (numeric)
    - `image_url` (text)
  ...
  - `cart_items` - Shopping cart items
    ...
    - `custom_price` (numeric, nullable) - For customized items
    - `created_at` (timestamptz)
    - `updated_at` (timestamptz)
  ...
  - Public read access for products and customization options
*/
